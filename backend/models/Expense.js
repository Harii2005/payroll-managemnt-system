...
const expenseSchema = new mongoose.Schema({
  ...
  category: {
    ...
    enum: ['travel', 'food', 'accommodation', 'transport', 'office_supplies', 'training', 'medical', 'other'],
    default: 'other'
  },
  expenseDate: {
    type: Date,
...
expenseSchema.statics.getEmployeeExpenses = function(employeeId, status = null) {
